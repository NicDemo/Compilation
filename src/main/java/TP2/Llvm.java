...
public class Llvm {
    ...
    public static class Start extends Instruction {
        ArrayList<String> params;
        String name;
        Type type;
        TP2.ASD.Instruction i;

        public Start(Type type, String name, ArrayList<String> params) {
            this.type = type;
            this.name = name;
            this.params = params;
            this.i = i;
        ...
        @Override
        public String toString() {
            String rez = "define " + type.toString() + " @" + name + "(";
            if(params.size()>0) {
    ...
    public static class Ending extends Instruction {
        ArrayList<String> params;
        String name;
        Type type;

        public Ending(Type type, String name, ArrayList<String> params) {
            this.type = type;
            this.name = name;
            this.params = params;
        }
        ...
        public String toString() {
            String rez = "";
            if (type instanceof Llvm.Void) {
                rez += " \n ret " + type.toString() + "\n}\n";
            }
            if (type instanceof Llvm.Int) {
                rez += " \n ret " + type.toString() + " 0\n}\n";
            }
            return rez;
        }
        ...
        public static class Call extends Instruction{
            Type type;
            List<Expression.RetExpression> arg;
            String name;
            String rez;
            public Call(Type type,String name,String rez,List<Expression.RetExpression> arg){
                this.arg=arg;
                this.name= name;
                this.type=type;
                this.rez=rez;
