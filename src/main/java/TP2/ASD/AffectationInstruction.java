...
public class AffectationInstruction extends TP2.ASD.Instruction {
	...
	@Override
	public RetInstruction toIR() throws TypeException, Exception {
		Expression.RetExpression retexpression = exp.toIR();
		VariableSymbol symbol = (VariableSymbol) TP2.Main.tabsymb.lookup(id);
